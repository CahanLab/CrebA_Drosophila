SAMPLETYPE = "crebA_early"
TARGET_dir = file.path("results", ANALYSIS_VERSION, "crebA_early_integrated")
...
VlnPlot(object, group.by = "Integrated_tentativeCellType", features = 'trh', pt.size = 0)
ggsave(file.path(TARGET_dir, "trh_gene.png" ), width = 9, height = 6)

VlnPlot(object, group.by = "Integrated_tentativeCellType", features = 'Cht5', pt.size = 0)
