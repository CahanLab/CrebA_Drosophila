TARGET_dir = file.path("results", ANALYSIS_VERSION, "manual_annotation_crebA_early")
dir.create(TARGET_dir, recursive = TRUE)
object = readRDS(file.path("results", ANALYSIS_VERSION, "crebA_early_integrated/BDGP_automated_annotation_object.rds"))
manual_annotation = read.csv(file.path("accessory_data/manual_annotation", ANALYSIS_VERSION, "crebA_early/manual_annotations.csv"))
