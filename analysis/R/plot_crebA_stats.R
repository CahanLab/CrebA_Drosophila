...
crebA_late_object = readRDS(file.path('results', ANALYSIS_VERSION, 'manual_annotation_crebA/manual_celltype_object.rds'))
...
DimPlot(crebA_late_object, group.by = 'seurat_clusters') + 
  ggtitle("Stage 13-16 CrebA Mutant Embryos")
ggsave(file.path(TARGET_dir, "clusters_creba_late_umap.png"), width = 10, height = 7)
