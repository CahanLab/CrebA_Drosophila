...
ggsave(filename = file.path(TARGET_dir, 'wildtype_selected_ct3.png'), width = 11.2, height = 5)
...
ggsave(filename = file.path(TARGET_dir, 'mutant_selected_ct3.png'), width = 11.2, height = 5)
