...
w = 200
w_end = 200 # this is just arbritary 
...
tss_table.to_csv("../output/tss_table/regulatory_regions_table_400bp.txt", index = False)
...
tss_table.to_csv("../output/tss_table/regulatory_regions_400bp.bed", index = False, header = False, sep = '\t')