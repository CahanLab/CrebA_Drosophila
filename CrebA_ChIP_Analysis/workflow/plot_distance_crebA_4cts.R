...
output_path = '../output/plot_location_crebA_binding_4cts'
...
down_DE = read.csv("../output/find_bound_DE_genes_4cts/down_DE.csv", row.names = 1)
...
up_DE = read.csv("../output/find_bound_DE_genes_4cts/up_DE.csv", row.names = 1)
