...
TARGET_dir = file.path("../output/enrichment_categorized_DE_genes_4cts")
dir.create(TARGET_dir, recursive = TRUE)

##### get the DE genes ###### 
down_DE_genes = read.csv("../output/find_bound_DE_genes_4cts/down_DE.csv", row.names = 1)
up_DE_genes = read.csv("../output/find_bound_DE_genes_4cts/up_DE.csv", row.names = 1)
