...
tss_table.to_csv("../output/tss_table/regulatory_regions_table.txt", index = False)
...
tss_table.to_csv("../output/tss_table/regulatory_regions.bed", index = False, header = False, sep = '\t')