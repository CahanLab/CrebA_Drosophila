...
input_path = file.path("../output/get_functional_peak_regions/dreme_down_DE_peaks/")
...
##### make logo sequence up #####
input_path = file.path("../output/get_functional_peak_regions/dreme_up_DE_peaks/")
output_path = file.path(input_path, 'logo_seq')
...
##### make logo sequence null #####
input_path = file.path("../output/get_nonfunctional_peak_regions/dreme_150_top_nonfunctional_peaks/")
output_path = file.path(input_path, 'logo_seq')
